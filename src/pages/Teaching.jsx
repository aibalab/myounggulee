    ...
    return (
        <div className="bg-night-950 py-16 sm:py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <p className="text-xs font-semibold uppercase tracking-[0.25em] text-primary-400 mb-4">Courses</p>
                    ...
                    {teachingData.map((inst, idx) => (
                        <section key={idx}>
                            <div className="border-b border-white/[0.08] pb-4 mb-8">
                                <h2 className="text-2xl font-semibold text-white">{inst.university}</h2>
